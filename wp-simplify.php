...
class WP_Simplify {
  ...
  public function admin_head() {
    ...
    if( in_array( 'disable_useless_metaboxes', $wp_simplify ) ) {
      ...
      WP_Simplify::remove_ui_elements( 'page', array(
        'postcustom',
        'trackbacksdiv',
        'revisionsdiv',
        'slugdiv',
      ...
      WP_Simplify::remove_ui_elements( 'post', array(
        'postcustom',
        'trackbacksdiv',
        'revisionsdiv',
        'slugdiv',
  ...
  public function wp_dashboard_setup() {
    ...
    if( in_array( 'disable_dashboard_metaboxes', $wp_simplify ) ) {
      WP_Simplify::remove_ui_elements( 'dashboard', array(
        'dashboard_right_now',
    ...
    if( in_array( 'disable_right_now_widget', $wp_simplify ) ) {
      WP_Simplify::remove_ui_elements( 'dashboard', array( 'dashboard_right_now' ) );
    }

    if( in_array( 'disable_comments', $wp_simplify ) ) {
      WP_Simplify::remove_ui_elements( 'dashboard', array( 'dashboard_recent_comments' ) );
      WP_Simplify::remove_ui_elements( 'page', array( 'commentsdiv' ) );
      WP_Simplify::remove_ui_elements( 'post', array( 'commentsdiv' ) );
    }

    if( in_array( 'disable_posts', $wp_simplify ) ) {
      WP_Simplify::remove_ui_elements( 'dashboard', array( 'dashboard_quick_press', 'dashboard_recent_drafts' ) );
    }
